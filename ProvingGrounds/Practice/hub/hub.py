...
parser.add_argument("-sp", "--sport", help="https port [Default 443]")
...
def login(r, s):
    ...
    r = s.post(f"https://{url}:{sport}/rtl/protected/wfslinks.lsp", data=data,
               verify=False)  # switching to https cause its easier to script lolz
